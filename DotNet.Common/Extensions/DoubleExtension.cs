...
namespace System
{
    public static class DoubleExtension
    {
        ...
        /// <returns></returns>
        public static String ToChineseCapital(this double value)
        {
            DigitToChineseCapital digitToChineseCapital = new DigitToChineseCapital();

            return digitToChineseCapital.Convert(value.ToString(), false);
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static String ToChineseOrdinary(this double value)
        {
            DigitToChineseOrdinary digitToChineseCapital = new DigitToChineseOrdinary();
            return digitToChineseCapital.Convert(value.ToString(), false);
        }
    }
    ...
    class DigitToChineseCapital
    {
        ...
        // 构造函数
        //
        public DigitToChineseCapital()
        {
            // 一般大写中文数字组
            //chnGenText = new char[] { '零', '一', '二', '三', '四', '五', '六', '七', '八', '九' };
            chnGenText = new char[] { '零', '壹', '贰', '叁', '肆', '伍', '陆', '染', '捌', '玖' };
            chnGenDigit = new char[] { '拾', '佰', '仟', '万', '亿' };
