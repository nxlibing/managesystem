/*
	...
	Features:
		...
		*Adds several Formatting functions for formatting that values provided on the file object.
			...
			- SWFUpload.speed.formatUnits(baseNumber, divisionArray, unitLabelArray, fractionaDotNetoolean)
				- Formats a number using the division array to determine how to apply the labels in the Label Array
				- factionaDotNetoolean indicates whether the number should be returned as a single fractional number with a unit (speed)
