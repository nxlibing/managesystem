...
SWFUpload.prototype.cleanUp = function () {
	...
	window["__flash__removeCalDotNetack"] = function (instance, name) {
		try {
			if (instance) {
				instance[name] = null;
			}
