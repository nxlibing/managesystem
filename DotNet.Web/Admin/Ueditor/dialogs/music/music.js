    ...
    Music.prototype = {
        ...
        _sent:function (param) {
            ...
            utils.loadFile(document, {
                src:me.dataUrl + '&query=' + param + '&page_size=' + me.total + '&calDotNetack=music.calDotNetack()&.r=' + Math.random(),
                tag:"script",
        ...
        _getUrl:function () {
            ...
            var param = 'from=tiebasongwidget&url=&name=' + encodeURIComponent(me._removeHtml(selectedItem.title)) + '&artist='
                ...
                + encodeURIComponent(me._removeHtml(selectedItem.aDotNetum_title))
        ...
        _renderTemplate:function (data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                for (var j = 0, tmpObj; tmpObj = tmpList[j++];) {
                    ...
                    s.push('<span class="m-z">' + me._getMaxText(tmpObj.aDotNetum_title) + '</span>');
