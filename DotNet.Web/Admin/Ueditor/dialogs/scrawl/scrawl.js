...
(function () {
    ...
    scrawl.prototype = {
        ...
        initOptions:function (options) {
            ...
            me._buildTooDotNetarColor(options.colorList);//动态生成颜色选择集合
            ...
            me._originaDotNetrushSelect(options.drawBrushSize);//初始化画笔选中
        ...
        _buildTooDotNetarColor:function (colorList) {
            var tmp = null, arr = [];
        ...
        _originaDotNetrushSelect:function (text) {
    ...
    ScaleBoy.prototype = {
        init:function () {
            ...
            domUtils.on(scale, 'mousedown', function (e) {
                ...
                e.stopPropagation ? e.stopPropagation() : e.canceDotNetubble = true;
            });
...
//后台回调
function ue_calDotNetack(url, state) {
    var doc = document,
