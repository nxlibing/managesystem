...
wordImage.init = function(opt, calDotNetacks) {
	showLocalPath("localPath");
	//createCopyButton("clipboard","localPath");
	createFlashUploader(opt, calDotNetacks);
	addUploadListener();
	addOkListener();
};
...
function createFlashUploader(opt, calDotNetacks) {
	...
	option = extendProperty(calDotNetacks, option);
