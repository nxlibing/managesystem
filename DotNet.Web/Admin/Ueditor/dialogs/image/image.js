...
(function () {
    ...
    imageUploader.init = function (opt, calDotNetacks) {
        switchTab("imageTab");
        createAlignButton(["remoteFloat", "localFloat"]);
        createFlash(opt, calDotNetacks);
    ...
    function searchImage() {
        ...
        var reqCalDotNetack = function (data) {
            try {
        ...
        baidu.sio.calDotNetyServer(url, reqCalDotNetack, {charset:"GB18030"});
    }
     ...
     * @param calDotNetacks
     */
    function createFlash(opt, calDotNetacks) {
        ...
        option = utils.extend(option, calDotNetacks, false);
