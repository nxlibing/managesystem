...
UE.I18N['en'] = {
    ...
    'snapScreen_plugin':{
        ...
        'calDotNetackErrorMsg':"The calDotNetack data is wrong,please check the config!",
    ...
    'music':{
        'static':{
            'lang_input_tips':"Input singer/song/aDotNetum, search you interested in music!",
    ...
    insertframe:{
        'static':{
            ...
            'lang_input_width':'Width：',
            'lang_input_height':'height：',
            'lang_input_isScroll':'Enable scrolDotNetars：',
    ...
    searchreplace:{
        'static':{
            ...
            repalceAlDotNettn:{value:"Replace all"}
        },
